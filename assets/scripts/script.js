...
async function findCurrentWeatherInfo(cityInput) {
...
function generateCityList() {
    ...
    console.log(retrievedCitiesArray);
    for (var i = 0; i < retrievedCitiesArray.length; i++) {
        let eachListedCity = $("<li>").text(retrievedCitiesArray[i]);
