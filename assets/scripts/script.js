// let requestWeatherURL = "api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={lon}&appid=2f86475148abed664b43332f701d4d90";
...
// let requestCityWeather = "http://api.openweathermap.org/data/2.5/forecast?q="+cityInput+"&appid=2f86475148abed664b43332f701d4d90";
...
function storeSearchedCities(weatherData) {
    let storeCity = weatherData.city.name;
    let cityLat = weatherData.city.coord.lat;
    let cityLon = weatherData.city.coord.lon;
    let storeKey = "" + cityLat + cityLon;
    localStorage.setItem(storeKey, storeCity);
}

$(searchButton).click(findCurrentWeatherInfo);